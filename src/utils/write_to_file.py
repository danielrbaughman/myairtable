...
class WriteToFile(BaseModel):
    ...
    path: Path
    lines: list[str] = []
    language: Literal["python", "typescript", "javascript", "markdown", "mermaid", "rust", "html", "swift", "kotlin", "java", "go", "csharp"]
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        if exc_type is None:
            ...
            match self.language:
                ...
                case "typescript" | "javascript" | "rust" | "swift" | "kotlin" | "java" | "go" | "csharp":
                    header: str = (
                        "// ==========================================\n"
                        "// Auto-generated file. Do not edit directly.\n"
                        "// ==========================================\n\n"
